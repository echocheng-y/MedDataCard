...
**Convenience sample.** The 26 datasets are a flagship set covering major modalities, not a census of medical-AI datasets; generalizability is bounded accordingly.
...
**Literature verification.** MONET (*Nat. Med.* 2024;30(4), DOI 10.1038/s41591-024-02887-x) volume, issue, and pages are verified; UNI, CONCH, and Virchow, also *Nat. Med.* 2024 exemplars, need final verification before submission (search date August 2026).
...
8. Chen, R. J. et al. Towards a general-purpose foundation model for computational pathology. *Nat. Med.* (2024). DOI:10.1038/s41591-024-02857-3
9. Lu, M. Y. et al. A visual-language foundation model for computational pathology. *Nat. Med.* (2024). DOI:10.1038/s41591-024-02856-4
...
12. MONET: a literature-based image-text foundation model for transparent medical imaging AI. *Nat. Med.* 30, (2024). DOI:10.1038/s41591-024-02887-x
